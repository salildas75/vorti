...
public class PDFMainActivity extends AppCompatActivity {
    ...
    */
    public class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            if(view==null)
            {
                view= LayoutInflater.from(c).inflate(R.layout.pdf_row_model,viewGroup,false);
            }
            ...
            {
                Picasso.get().load(pdf.getPdfIconURL()).placeholder(R.drawable.logo).into(pdfIcon);
            }else {
    ...
    */
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://192.168.1.101/vorti_php/member/pdfstore.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressBar myProgressBar= findViewById(R.id.myProgressBar);
                ...
                new JSONDownloader(PDFMainActivity.this).retrieve(myGridView,myProgressBar);
